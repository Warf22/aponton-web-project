...
For Project 2, I created a basic HTML webpage about one of my hobbies, which is camping in the Gila National Forest. I chose this theme because it is something I am actually interested in, so it made the page easier to build and write about. My page includes the required HTML elements like headings, paragraphs, lists, an image, a table, and navigation links between pages.
